...
- Poster maintenance on 2026-07-13 enriched and verified `The Grim Lover`, then strictly rejected an ambiguous replacement for `House of the Dragon: The House That Dragons Built`. After the Douban placeholder repair, the 2026-07-14 active-catalog audit reported 1,628 works, 1,450 healthy posters, zero unverified/degraded/broken images, 178 missing and 4 undersized posters. Missing lookups are split into 2 not attempted, 176 cooling down and 0 retry-eligible; all 4 low-resolution replacements are cooling down, and both caches have zero corrupt or orphaned entries.
