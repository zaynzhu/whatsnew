...
- Poster maintenance on 2026-07-14 reports 1,638 active works, 1,511 healthy posters, zero unverified/degraded/broken images, 127 missing and 4 undersized posters. A live OMDb check exposed both failure modes now guarded in code: one exact IMDb result returned an unavailable Amazon URL, and another returned a 300×169 horizontal image. Both records were restored to their verified TVmaze artwork without changing identity data.
