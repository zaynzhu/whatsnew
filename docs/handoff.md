...
- `/preview` no longer has the former 500-row read cap. After the 2026-07-13 hot-rank integration, a real main-database request returned all 214 current Douban upcoming works, including 40 official hot-list matches: 20 movies and 20 series.
