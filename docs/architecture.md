...
7. Every attempt writes `posterLookupAttemptedAt`; unsuccessful records become eligible again after 3 days so new and upcoming titles can pick up newly published artwork without blocking untouched titles.
