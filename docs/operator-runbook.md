...
| A title stays without artwork | Confirm TMDb is enabled and credential-complete, then run `enrich:posters`. Strict unmatched or conflicting titles remain without artwork and wait 3 days; do not restore a source-generic placeholder. |
